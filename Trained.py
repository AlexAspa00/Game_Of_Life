'''
This file is used to test and observe the behavior of 2 already trained creatures.
'''
import pickle
    ...
    if (id_specie == 0):
        ...
        with open("Results_Sp1/" + test + "/winner.pkl", "rb") as f:
            ...
            genomes = [(1, genome), (2, genome), (3, genome), (4, genome), (5, genome), (6, genome), (7, genome),
                       (8, genome), (9, genome), (10, genome)]
            while (1):
                run_sp1(genomes,config)
...
if __name__ == "__main__":
    ...
    config_path = "Results_Sp1/122/config-feedforward.txt"
