'''
This file is used to train the red creature in different random scenarios.
'''
import pickle
...
class Criatura1:
    ...
    def check_collision(self, cri, screen):
        ...
        for i, f in enumerate(food2):
            ...
            if dist < (self.radius + f.radius) and self.radius != 40:
                self.hungry = self.hungry + 500
                self.total_ate += 10
                food2.pop(i)
    ...
    def get_reward(self):
        return (((time.time() - self.time)) + (self.total_ate))
...
def run_neat(config,id_specie):
    ...
    if (id_specie == 0):
        ...
        p.add_reporter(neat.Checkpointer(generation_interval=500, time_interval_seconds=1200,
                                         filename_prefix="Results_Sp1/" + test + "/neat-checkpoint-"))
        p.add_reporter(stats)

        winner = p.run(run_sp1, 3000)
        ...
        node_names = {-1: 'Radar1', -2: 'Radar2', -3: 'Radar3', -4: 'Radar4', -5: 'Radar5', -6: 'R1', -7: 'G1',
                      ...
                      -20: 'B5', -21: 'PosX', 0: 'Angle', 1: 'Speed', 2: 'Radius'}
        ...
        with open("Results_Sp1/" + test + "/winner.pkl", "wb") as f:
            ...
            f.close()
        with open("Results_Sp1/" + test + '/real_winner.pkl', "wb") as f:
            pickle.dump(win, f)
            f.close()
        ...
        with open("Results_Sp2/" + test + "/real_winner.pkl", "rb") as f:
            ...
            genomes = [(1, genome), (2, genome), (3, genome), (4, genome), (5, genome), (6, genome), (7, genome),
                       (8, genome), (9, genome), (10, genome),(11, genome), (12, genome), (13, genome), (14, genome),
                       (15, genome), (16, genome), (17, genome), (18, genome), (19, genome), (20, genome)]
            while (1):
                run_sp2(genomes,config)
...
if __name__ == "__main__":
    ...
    config_path = "Results_Sp2/119/config-feedforward-2.txt"
