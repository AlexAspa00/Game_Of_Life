'''
This file is used to train the blue creature in different random scenarios.
'''
import pickle
...
class Food:
    def __init__(self, rad, x, y):
        self.radius = rad
        self.pos = [int(random.randint(self.radius + 350, (screen_width - self.radius))),
...
class Criatura1:
    def __init__(self, rad, x, y, id):
        self.radius = rad
        self.pos = [int(random.randint(self.radius + 300, (screen_width - self.radius))),
                    int(random.randint(self.radius, screen_height - self.radius))]
        self.id = id
        self.is_alive = True
...
def run_sp2(genomes, config):
    ...
    food = [Food(20, 300, 50), Food(20, 350, 320), Food(20, 350, 520), Food(20, 300, 300), Food(20, 300, 700),
            Food(20, 500, 150), Food(20, 500, 350), Food(20, 500, 650), Food(20, 700, 200), Food(20, 700, 400),
            Food(20, 700, 600),
            Food(20, 900, 50), Food(20, 900, 300), Food(20, 900, 700), Food(20, 1100, 50), Food(20, 1100, 300),
            Food(20, 1100, 700), Food(20, 1300, 150), Food(20, 1300, 350), Food(20, 1300, 650),
            Food(20, 1400, 200), Food(20, 1400, 400), Food(20, 1400, 600), Food(20, 1450, 50), Food(20, 1450, 300),
            Food(20, 1450, 700),
            ...
            Food(20, 100, 600), Food(20, 300, 520), Food(20, 900, 390), Food(20, 1100, 800), Food(20, 1100, 530),
            Food(20, 1200, 300),
            Food(20, 1300, 500), Food(20, 1400, 190), Food(20, 1400, 340), Food(20, 1450, 600), Food(20, 1250, 300),
            Food(20, 1250, 400),
            Food(20, 1250, 700), Food(20, 1250, 100), Food(20, 1150, 300), Food(20, 1150, 700), Food(20, 300, 200),
            Food(20, 400, 300),
            Food(20, 150, 300), Food(20, 350, 200), Food(20, 550, 100), Food(20, 300, 100), Food(20, 350, 200),
            Food(20, 450, 200)
            ]

    total_criatures[0] = [Criatura1(40, 50, 400, 1), Criatura1(40, 150, 300, 2), Criatura1(40, 1250, 600, 3),
                          Criatura1(40, 600, 400, 4), Criatura1(40, 650, 500, 5), Criatura1(40, 850, 200, 6),
                          Criatura1(40, 950, 600, 7), Criatura1(40, 1150, 800, 8), Criatura1(40, 500, 400, 9),
                          Criatura1(40, 650, 300, 10), Criatura1(40, 450, 600, 11), Criatura1(40, 900, 700, 12),
                          #Criatura1(40, 850, 400, 13), Criatura1(40, 250, 300, 14),
                          #Criatura1(40, 1250, 600, 15), Criatura1(40, 1450, 400, 16), Criatura1(40, 300, 100, 17),
                          #Criatura1(40, 550, 200, 18), Criatura1(40, 1450, 100, 19), Criatura1(40, 1350, 250, 20),
                          Criatura1(40, 1100, 150, 21), Criatura1(40, 1050, 250, 20), Criatura1(40, 1200, 200, 20)]
    ...
    while True:
        ...
        for index, criatura in enumerate(total_criatures[1]):
            ...
            '''
            if output[0] >= 0.75:
                criatura.angle = math.radians(315)
            elif output[0] >= 0.5:
                criatura.angle = math.radians(270)
            elif output[0] >= 0.25:
                criatura.angle = math.radians(225)
            elif output[0] >= 0:
                criatura.angle = math.radians(180)
            elif output[0] >= -0.25:
                criatura.angle = math.radians(135)
            elif output[0] >= -0.5:
                criatura.angle = math.radians(90)
            elif output[0] >= -0.75:
                criatura.angle = math.radians(45)
            elif output[0] >= -1:
                criatura.angle = math.radians(0)
            '''
            criatura.speed = 10
...
def run_neat(config):
    ...
    p.add_reporter(neat.Checkpointer(generation_interval=500, time_interval_seconds=1200,
                                     filename_prefix="Results_Sp2/" + test + "/Checkpoints/neat-checkpoint-"))
    p.add_reporter(stats)
    winner = p.run(run_sp2, 1000)
    win = stats.best_genome()
